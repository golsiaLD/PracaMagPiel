...
\chapter{Wyniki badań}
	...
	Poniżej przedstawiono odpowiedzi respondentów na pytania ankietowe zawarte w załączniku \ref{app:ankieta}. Wyniki w postaci tabel przedstawiono w kolejnosci, w jakiej ich dane wykorzystane były w badaniach prawdziwości załozonych hipotez.

%hip 1
\input wynikitabele/Q2.tex

\input wynikitabele/Q32.tex

\input wynikitabele/Q24.tex
...
\input wynikitabele/Q11.tex

\input wynikitabele/Q13.tex
...
\input wynikitabele/Q15.tex

\input wynikitabele/Q14.tex

\input wynikitabele/Q27.tex

\input wynikitabele/Q12.tex

%hip 3

\input wynikitabele/Q29.tex

\input wynikitabele/Q28.tex

%hip 4

\input wynikitabele/Q5.tex

\input wynikitabele/Q7.tex

\input wynikitabele/Q20.tex

%hip 5

\input wynikitabele/Q21.tex

\input wynikitabele/Q9.tex
...
Test statystyczny wykazał istotną statystycznie różnice w kożystaniu ze zwolnień lekarskich gdy jest ku temu powód, tab. \ref{tab:Q32} od ilości etatów na któych pracuje pielęgniarz/arka, tab. \ref{tab:Q2}. Wartość Mantel-Haenshel $(\chi^2 (1, 115) = 3,87, p=0,049)$. Współczynnik korelacji liniowej Pearsona $(R = -0,2, p=0,049)$. Wartość ujemna tego współczynnika określa tą zalożność jako odwrotnie proporcjonalną: im większa ilość etatów tym rzadsze korzystanie ze zwolnien lekarskich, pomimo iż są do tego wskazania.

Również istotną statystycznie okazała się odwrotnie proporcjonalana zależnośc uczestnictwa w życiu rodzinnym i przyjacół, tab. \ref{tab:Q24} od ilości etatów, tab. \ref{tab:Q2}, Mantel-Haenshel $(\chi^2 (1, 115) = 4,02, p=0,045)$, $(R = -0,2, p = 0,045)$. 

Praca mimo choroby, tab. \ref{tab:Q31}, koreluje z ilością godzin pracy, tab. \ref{tab:Q3} $(R = 0,20, p = 0,038)$, z pracą w systemie zmianowym, tab. \ref{tab:Q4} $(R = 0,26, p = 0,006)$, z "przynoszeniem" do domu emocji, tab. \ref{tab:Q10}, $(R = 0,33, p = 0,000)$ oraz z odczuwaniem traumatyzacji wtórnej, tab. \ref{tab:Q11}, $(R = 0,21, p = 0,022)$.

Testy statystyczne wykazały, że osoby doświadczające zjawiska traumatyzacji częciej rozpoznają u siebie objawy wypalenia zawodowego, tab. \ref{tab:Q35}, 
...
Istotna statstycznie korelacja zachodzi pomiedzy przynoszeniem do domu emocji z pracy, tab. \ref{tab:Q10} a częstością wystepowania chorób, tab. \ref{tab:Q33}, Mantel-Haenshel $(\chi^2 (1, 115) = 6,91, p=0,009)$, $(R = 0,25, p = 0,009)$.
...
Zauważono korelację w postrzeganiu swojego środowiska pracy jako toksyczne, tab. \ref{tab:Q8}, a ilością stresu "przynoszonego" z pracy do domu w postaci mysli i emocji, tab. \ref{tab:Q10}. Test statystyczny Pearsona $\chi^2$ określa tą korelację jako istotną na poziomie $(\chi^2 (16, 115) = 35,4, p = 0,004)$.

Postrzeganie swojego środowiska pracy jako toksyczne, tab. \ref{tab:Q8}, koreluje również z deficytem poczucia bezpieczeństwa w pracy w zagrożeniu koronarovirusem, tab. \ref{tab:Q18}, Mantel-Haenshel $(\chi^2 (1, 115) = 7,20, p=0,007)$, $(R = -0,3, p = 0,007)$. 
...
Badania statystyczne wskazują, że osoby, które lepiej radzą sobie z niwelowaniem stresu, tab. \ref{tab:Q12}
	\begin{itemize}
		\item rzadziej przynoszą "pracę" do domu w postaci myśli i emocj, tab. \ref{tab:Q10}, Pearson $(\chi^2 (16, 115) = 30,49, p = 0,016)$,  $(R = -0,26, p = 0,006)$;
		...
		\item rzadziej sięgaja po uzywki w celu niwelowania stresu, tab. \ref{tab:Q13}, Pearson $(\chi^2 (16, 115) = 31,67, p = 0,011)$, $(R = -0,24, p = 0,009)$.
	\end{itemize}
...
%Q27 z Q3 ilosc godzin pracy%
	...
	Występuje również zależność nasilenia konfliktów praca - rodzina, tab. \ref{tab:Q27}, od średniiej miesięcznej ilości godzin pracy, tab. \ref{tab:Q3}, 
...
%7.	niezgody z powodu pracy w zawodzie
	...
	%Q28 z Q10
	Istotną statystycznie korelację zaobserwowano momiędzy przynoszenie "pracy" do domu w postaci myśli i emocji, tab. \ref{tab:Q10}, a wskazywaniem, że praca zawodowa jest powodem niezgody z partnerem, tab. \ref{tab:Q28}, Mantel-Haenshel $(\chi^2 (1, 115) = 12,08, p=0,001)$, $(R = 0,33, p = 0,001)$.
...
Testy wykazują istotne statystycznie korelacje większego zadowolenia z wyboru drogi zawodowej, \ref{tab:Q5}, z:
	\begin{itemize}
		\item rzadszym odczuwaniem dylematu, wynikającego z koniecznosci podnoszenia kwalifikacji, tab. \ref{tab:Q14}, Mantel-Haenshel $(\chi^2 (1, 115) = 3,97, p < 0,001)$, $(R = -0,36, p < 0,001)$;
		\item mniejszym odczuwaniem prasji społecznej wynikającej z oczekiwań wobec Systemu Ochrony Zdrowia, tab. \ref{tab:Q15}, Mantel-Haenshel $(\chi^2 (1, 115) = 7,38, p = 0,007)$, $(R = -0,25, p = 0,007)$;
	\end{itemize}
...
%		z Q15 presja społeczna
%		z Q35 wypalenie
Test statystyczney wykazuje istotną korelacje braku poczucia właściwego wykorzystania kompetencji pracownika, tab. \ref{tab:Q21}, z presją społeczą wynikającą z oczekiwań wobec Systemu Ochrony Zdrowia, tab. \ref{tab:Q15}, Pearson $(\chi^2 (16, 115) = 47,47, p < 0,001)$, $(R = 0,24, p = 0,012)$.
...
Poczucie bezpieczeństwa w pracy, tab. \ref{tab:Q18}, istotnie statystycznie koreluje z postrzeganiem środowiaska pracy jako wspierającego, tab. \ref{tab:Q7}, Pearson $(\chi^2 (16, 115) = 27,38, p = 0,037)$, $(R = 0,26, p = 0,005)$, oraz z systemami motywacyjnymi, tab. \ref{tab:Q9}, Pearson $(\chi^2 (16, 115) = 23,63, p = 0,023)$, $(R = 0,25, p = 0,008)$
...
W toku pracy badaweczej wykorzystano metodę analizy piśmiennictwa z wykorzystaniem klasycznych technik treściowych, oraz metodę sondażu diagnostycznego z wykorzystaniem techniki ankietowej – autorskiego formularza ankiety. 
